...
PoW labels require an inspected algorithm, difficulty/parameters, verifier and reproducible vector. A project describing itself as proof-of-work is only a discovery lead for that stronger label. Service quickstarts, broad surveys and general CAPTCHA benchmarks are outside the [curation policy](CURATION.md).
