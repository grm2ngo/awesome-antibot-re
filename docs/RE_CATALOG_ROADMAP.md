...
3. Sensor, signing and crypto reconstruction
4. Browser-engine and runtime instrumentation
5. TLS, HTTP and browser fingerprint RE
6. CAPTCHA and challenge implementation RE
7. Detection predicates, anti-debug and tamper analysis
8. Proof-of-work and computational challenges
9. Mobile, WebView and embedded-browser anti-bot
10. Datasets, traces and reproducible measurement
