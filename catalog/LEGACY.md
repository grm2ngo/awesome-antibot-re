# Previous catalogue — pending audit

Preserved from [commit 01bebee](https://github.com/grm2ngo/awesome-antibot-re/tree/01bebee59403cd91b7633b10e747990c62a610f0) on 2026-09-11. Entries below retain their earlier descriptions and date claims; they have **not all passed policy 1.0**. This is a migration queue, not an allegation that the resources are bad. Promote an item only after recording evidence. The earlier scheduling statement has been superseded by [Automation](../docs/AUTOMATION.md).

[Back to the curated list](../README.md).
